...
(function () {
  ...
  function startConfettiInner() {
    var div = document.getElementById("booking-confetti");
    ...
    if (canvas === null) {
      ...
      div.appendChild(canvas); // Append to the specific div instead of body
      canvas.width = width;
    ...
    if (animationTimer === null) {
      (function runAnimation() {
        context.clearRect(0, 0, div.offsetWidth, div.offsetHeight);
